...
import { PostCreationRequest, PostValidator, postPatchSchema } from "@lib/validators/post";
...
const Editor: FC<EditorProps> = ( { post }: EditorProps) => {
  ...
  const { mutate: createPost } = useMutation({
    mutationFn: async ({ title, content, postId }: PostCreationRequest) => {
      const payload: PostCreationRequest = { title, content, postId };
